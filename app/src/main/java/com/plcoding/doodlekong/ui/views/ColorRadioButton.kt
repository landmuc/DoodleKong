...
// @JVMOverloads used for constructor generation
class ColorRadioButton @JvmOverloads constructor(
    ...
    // Anti-aliasing is a technique used in computer graphics to reduce
    // the visual distortion known als aliasing -> make edges of shapes appear smoother
